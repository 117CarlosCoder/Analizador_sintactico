 ...
 * @author carlos117
 */
public class AsignacionPertenencia {
    private List<Object> lista;
    private final List<List<Object>> listaTotal;
    private String Bloque;

    public AsignacionPertenencia() {
        lista = new ArrayList<>();
    ...
    private List<List<Object>> Valor(Stack pila) {
        ...
        if (valor.get(1) == Identificador.OPIPERT) {
            System.out.println(valor);
            ...
            switch ((Identificador) valor.get(1)) {
                case OPIPERT :
                    ...
                    lista = Arrays.asList( lista, Identificador.ASIGOPPERT, "Asignacion Operador Pertenencia",Bloque);
